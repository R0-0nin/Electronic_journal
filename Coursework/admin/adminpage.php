        ...
        <div class="col mt-1">
            ...
            <table class="table shadow">
                ...
                <tr>
                    ...
                    <th style="text-align: center; vertical-align: middle;">Почта</th>
                ...
                <?php foreach ($result as $value) { ?>
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><?=$value['role'] ?></td>
                        <td style="text-align: center; vertical-align: middle;"><?=$value['subject'] ?></td>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" name="mail" value="" placeholder="Почта">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="pass" value="" placeholder="Личный пароль">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="subject" value="" placeholder="Предмет">
                    </div>
                    <div class="form-group">
                        <select name = "role">
